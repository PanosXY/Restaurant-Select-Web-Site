...
function UserNameAlert(){
	document.getElementById("UsernameJS2").innerHTML="Προσοχή:<br />Υπάρχει διάκριση μεταξύ<br />κεφαλαίων-πεζών,<br />Αγγλικών-Ελληνικών χαρακτήρων<br />και αριθμών-συμβόλων";
}
...
function PasswordAlert(){
	document.getElementById("PasswordJS2").innerHTML="Προσοχή:<br />Υπάρχει διάκριση μεταξύ<br />κεφαλαίων-πεζών,<br />Αγγλικών-Ελληνικών χαρακτήρων<br />και αριθμών-συμβόλων";
}
